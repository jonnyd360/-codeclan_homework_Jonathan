...
The calculated correlation is .804 with indicates stong to very strong correlation between the values
...
Ok I am confused at this part.
Not to sure what I did is right

```{r}

autoplot(model)

bootstrap_distribution_slope <- reg %>%
