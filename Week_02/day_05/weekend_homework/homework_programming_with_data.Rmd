...
For this weekend homework you will create a new GitHub repo **with a README** that contains an R project with two pieces of code:
...
Make a file called `README.md`. In this file we just want you to describe the structure of your project, and explain what each piece of code you have written does.
